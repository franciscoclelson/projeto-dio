...
A primeira linha do documento deve ser o _<!DOCTYPE html>_, apesar de parecer um elemento HTML ela apenas diz ao navegador que ele está lidando com um arquivo do tipo HTML5. Os elementos HTML vem logo abaixo.
...
O elemento a tem vários atributos, mas vamos focar em dois, o **_href_** e o **_target._**
...
O elemento img é bem simples, contendo apenas 2 atributos próprios, o **_src e o alt._**
